...
class SemanticKernelProductManagementAgent:
    ...
    def __init__(self):
        ...
        # Define a ProductAgent to handle product-related queries
        ...
        # Define a RankerAgent to handle ranking and recommendations
        ...
        self.agent = ChatCompletionAgent(
            ...
            instructions=(
                ...
                "You are a helpful assistant for Zava, a home improvement store. "
                "Provide product information, recommendations, and assistance with product selection. "
                "Always respond in JSON format with 'status' and 'message' fields. "
                "Use status 'completed' when you've provided a complete answer, "
                "'input_required' when you need more information from the user, "
                "or 'error' if something went wrong. "
                "Be friendly, professional, and provide helpful product information and recommendations. "
                "If you don't have specific product data, provide general helpful guidance about home improvement products and encourage users to check with store staff for detailed product information."
            ),
